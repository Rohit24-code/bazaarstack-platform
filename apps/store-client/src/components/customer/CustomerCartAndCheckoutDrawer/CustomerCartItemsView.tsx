...
import { CustomerCartItemIdentifier, CustomerCartResponse } from "@/features/customer/cartAndCheckout/types";
...
export type CustomerCartItemsProps = {
  cart: CustomerCartResponse;
  onIncrease: (item: CustomerCartItemIdentifier) => void;
  onDecrease: (item: CustomerCartItemIdentifier) => void;
  onRemove: (item: CustomerCartItemIdentifier) => void;
  setOpen: (value: boolean) => void;
};

export function CustomerCartItemsView({
  cart,
  onIncrease,
  onDecrease,
  onRemove,
