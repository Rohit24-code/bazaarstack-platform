...
import { homeStyles } from "@/pages/customer/constant";
import type { CustomerHomeResponse } from "@/features/customer/home/types";

type CustomerHomeViewProps = {
  data: CustomerHomeResponse;
};

export default function CustomerHomeView({ data }: CustomerHomeViewProps) {
            ...
            <section>
              ...
              <div className={homeStyles.couponGridClass}>
                {data.coupons.slice(0, 4).map((coupon) => (
                  <Card key={coupon._id} className={homeStyles.couponCardClass}>
